...
export function ToastProvider({ children }: { children: ReactNode }) {
 ...
 {children}
 <div aria-live="polite" className="pointer-events-none fixed bottom-4 right-4 z-[80] flex w-[calc(100vw-2rem)] max-w-sm flex-col-reverse gap-3 sm:right-6" role="status">
 <AnimatePresence>
 {items.map((item) => {
 ...
 className="pointer-events-auto overflow-hidden rounded-lg border bg-background p-4 shadow-glass "
