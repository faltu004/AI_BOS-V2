...
export function NotificationBell() {
 ...
 {open && (
 <div className="absolute right-0 top-full z-50 mt-2 w-80 rounded-lg border border-border bg-background p-2 shadow-2xl shadow-foreground/20 dark:bg-slate-950">
