...
export function RiskMatrix({ data, className }: RiskMatrixProps) {
 ...
 <div className="absolute bottom-full left-1/2 mb-2 hidden -translate-x-1/2 whitespace-nowrap rounded-lg border bg-background px-3 py-2 text-xs shadow-glass group-hover:block">
