...
export function AuthLayout({ children, eyebrow, title, subtitle }: AuthLayoutProps) {
 ...
 <div className="absolute left-[8%] top-24 h-20 w-20 rotate-12 rounded-lg border border-white/30 bg-white " />
 <div className="absolute bottom-16 right-[9%] h-16 w-16 -rotate-12 rounded-lg border border-primary/20 bg-primary/10 " />
 ...
 <CompanyLogo className="mx-auto w-fit" subtitle={eyebrow} />
 </div>
