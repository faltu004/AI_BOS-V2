...
function InvoiceFormModal({
 ...
 const updateField = <K extends keyof InvoiceFormInput>(field: K, value: InvoiceFormInput[K]) => {
 ...
 className="max-h-[92vh] w-full max-w-3xl overflow-y-auto rounded-lg border bg-background p-5 shadow-glass"
 ...
 <Input id="customer" required value={form.customer} onChange={(event) => updateField("customer", event.target.value)} />
 </div>
 <div className="space-y-2">
 ...
 <Input id="issueDate" type="date" value={form.issueDate} onChange={(event) => updateField("issueDate", event.target.value)} />
 </div>
 <div className="space-y-2">
 ...
 <Input id="itemDescription" required value={form.itemDescription} onChange={(event) => updateField("itemDescription", event.target.value)} />
 </div>
 <div className="space-y-2">
 <Label htmlFor="quantity">Quantity</Label>
 <Input id="quantity" min={1} type="number" value={form.quantity} onChange={(event) => updateField("quantity", Number(event.target.value))} />
 </div>
 <div className="space-y-2">
 <Label htmlFor="rate">Rate</Label>
 <Input id="rate" min={0} type="number" value={form.rate} onChange={(event) => updateField("rate", Number(event.target.value))} />
 </div>
 <div className="space-y-2">
 <Label htmlFor="taxRate">Tax Rate</Label>
 <Input id="taxRate" min={0} type="number" value={form.taxRate} onChange={(event) => updateField("taxRate", Number(event.target.value))} />
 </div>
 <div className="rounded-lg border bg-muted p-4">
 <p className="text-sm text-muted-foreground">Estimated Total</p>
 <p className="mt-2 text-2xl font-bold">{formatMoney(form.quantity * form.rate * (1 + form.taxRate / 100))}</p>
 </div>
 </div>
