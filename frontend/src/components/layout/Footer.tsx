        ...
        <div className="space-y-4">
          ...
          <form className="flex gap-2">
            <input
              ...
              className="h-10 min-w-0 flex-1 rounded-md border bg-background/70 px-3 text-sm outline-none transition-colors placeholder:text-muted-foreground focus:border-primary"
