...
function LoadingOverlay({ active }: { active: boolean }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-background/60 backdrop-blur-sm" aria-live="polite" aria-label="Loading">
      <motion.div
...
function IconCard({ item, index }: { item: IconItem; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group h-full cursor-pointer overflow-hidden rounded-lg border bg-card/70 hover:-translate-y-1 hover:border-primary/40 hover:shadow-glass hover:shadow-primary/5"
    >
      <div className="p-6">
...
function HeroDashboard() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -right-3 bottom-16 hidden animate-float rounded-lg border border-white/50 bg-white/80 p-4 shadow-glass backdrop-blur-xl dark:border-white/10 dark:bg-white/10 sm:block" style={{ animationDelay: '1s' }}>
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-4">
            <div className="grid gap-3 sm:grid-cols-3">
              {[
                ...
                return (
                  <motion.div
                    className="rounded-md border bg-background/70 p-3 cursor-pointer"
                    key={item.label}
            ...
            <motion.div
              className="rounded-md border bg-background/70 p-4 cursor-pointer"
              whileHover={{ y: -2 }}
...
function HeroSection() {
  ...
  return (
    <section id="home" className="relative overflow-hidden bg-enterprise pt-28">
      ...
      <div className="absolute left-[7%] top-36 h-20 w-20 rotate-12 rounded-lg border border-white/50 bg-white/25 backdrop-blur-xl dark:border-white/10 dark:bg-white/10" />
        ...
        <div className="max-w-3xl space-y-8">
          ...
          >
            {securityItems.map((item) => {
              const Icon = item.icon;
              return (
                <div className="glass-soft rounded-md px-3 py-3 backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-lg" key={item.label}>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {trustedCompanies.map((company, index) => (
            <motion.div
              ...
              className="flex h-16 items-center justify-center rounded-md border bg-background/50 px-4 text-sm font-semibold text-muted-foreground transition-all duration-300 hover:border-primary/40 hover:text-foreground hover:shadow-sm"
            >
              {company}
            </motion.div>
          ))}
          ...
          {modules.map((module, index) => {
            ...
            return (
              <motion.div
                ...
                className="group h-full cursor-pointer rounded-lg border bg-card/70 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-glass hover:shadow-primary/5"
              >
                <motion.div
        ...
        {stats.map((stat, index) => {
          ...
          return (
            <motion.div
              ...
              className="rounded-lg border border-background/15 bg-background/10 p-7 text-center backdrop-blur-xl dark:border-slate-200 dark:bg-slate-50"
            >
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="h-full"
            >
              <Card className="h-full bg-card/70 hover:-translate-y-1 hover:border-primary/40 hover:shadow-glass transition-all duration-300">
