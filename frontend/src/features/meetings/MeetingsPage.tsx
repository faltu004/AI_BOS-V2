      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              id="participants"
              placeholder="Aman Verma, Sofia Alvarez"
      ...
      <CardContent className="space-y-4 p-5">
        ...
        <div className="flex flex-wrap gap-2">
          {meeting.attachments.map((attachment) => (
            <span className="inline-flex items-center gap-2 rounded-full border bg-background/60 px-3 py-1 text-xs font-semibold text-muted-foreground" key={attachment.name}>
        ...
        <Card className="glass">
          <CardContent className="space-y-4 p-4">
            <div className="grid gap-3 lg:grid-cols-[1fr_170px_170px]">
              ...
              <select className="h-11 rounded-md border bg-background/75 px-3 text-sm" value={dateFilter} onChange={(event) => setDateFilter(event.target.value)}>
                <option>All</option>
                <option>Today</option>
          ...
          <aside className="space-y-4">
            <Card className="glass">
              ...
              <CardContent className="space-y-3">
                {filteredMeetings.map((meeting) => (
                  <div className="rounded-lg border bg-background/65 p-3" key={`${meeting.id}-calendar`}>
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
            ...
            <Card className="glass">
              ...
              <CardContent className="space-y-2">
                {meetingParticipants.map((participant) => (
                  <div className="flex items-center gap-3 rounded-lg border bg-background/65 p-3" key={participant}>
