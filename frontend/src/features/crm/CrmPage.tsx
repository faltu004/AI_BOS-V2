...
function LeadFormModal({
  ...
  const updateField = <K extends keyof LeadFormInput>(field: K, value: LeadFormInput[K]) => {
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <Input id="leadName" required value={form.name} onChange={(event) => updateField("name", event.target.value)} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="company">Company</Label>
            <Input id="company" required value={form.company} onChange={(event) => updateField("company", event.target.value)} />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label>Source</Label>
            <select className="h-11 w-full rounded-md border bg-background px-3 text-sm" value={form.source} onChange={(event) => updateField("source", event.target.value)}>
          ...
          <div className="space-y-2">
            <Label>Stage</Label>
            <select className="h-11 w-full rounded-md border bg-background px-3 text-sm" value={form.stage} onChange={(event) => updateField("stage", event.target.value as LeadStage)}>
          ...
          <div className="space-y-2">
            ...
            <select className="h-11 w-full rounded-md border bg-background px-3 text-sm" value={form.salesperson} onChange={(event) => updateField("salesperson", event.target.value)}>
          ...
          <div className="space-y-2">
            ...
            <Input id="value" min={0} type="number" value={form.value} onChange={(event) => updateField("value", Number(event.target.value))} />
          </div>
          <div className="space-y-2">
            <Label htmlFor="nextFollowUp">Next Follow Up</Label>
            <Input id="nextFollowUp" type="date" value={form.nextFollowUp} onChange={(event) => updateField("nextFollowUp", event.target.value)} />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <Input id="notes" placeholder="Budget confirmed, wants demo" value={form.notes.join(", ")} onChange={(event) => updateField("notes", parseList(event.target.value))} />
          </div>
        </div>
