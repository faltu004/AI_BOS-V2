...
export function ProjectDetailsPage() {
 ...
 <label className="flex items-center gap-3 rounded-lg border bg-background p-4" key={task}>
 ...
 <div className="rounded-lg border bg-background p-4"><p className="text-sm text-muted-foreground">Used</p><p className="text-2xl font-bold">{formatCurrency(project.budget * project.progress / 100)}</p></div>
 <div className="rounded-lg border bg-background p-4"><p className="text-sm text-muted-foreground">Remaining</p><p className="text-2xl font-bold">{formatCurrency(project.budget * (100 - project.progress) / 100)}</p></div>
 </div>
 </CardContent>
 </Card>
 )}
 ...
 <label className="flex items-center justify-between rounded-lg border bg-background p-4" key={setting}>
