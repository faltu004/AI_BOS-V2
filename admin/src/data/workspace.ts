...
export const workspaceSearchItems: WorkspaceSearchItem[] = [
  ...
  { id: "nav-team-accounts", title: "Team Accounts", category: "Employees", href: "/team-accounts", keywords: ["users", "accounts", "create profile", "onboard"], icon: UserPlus, roles: ["Administrator", "Owner", "Manager"] },
