...
export function SettingsPage() {
 ...
 <select className="h-11 w-full rounded-md border bg-background px-3 text-sm outline-none focus:border-primary" id="timezone">
 ...
 <select className="h-11 w-full rounded-md border bg-background px-3 text-sm outline-none focus:border-primary" id="language">
 ...
 <select className="mt-3 h-10 w-full rounded-md border bg-background px-3 text-sm outline-none focus:border-primary">
 ...
 Connect Google, Microsoft, Slack, GitHub, and other external services from the Integrations Center.
 </p>
 <Link className="text-sm font-semibold text-primary hover:underline" to="/integrations">
 Manage integrations →
 </Link>
 </div>
 </SettingsCard>
 ...
 return (
 <label className="flex cursor-pointer items-center justify-between gap-4 rounded-lg border bg-background p-4" key={item.label}>
 ...
 <div className="space-y-3">
 {apiKeys.map((key) => (
 <div className="rounded-lg border bg-background p-4" key={key.name}>
 ...
 <div className="flex items-center justify-between gap-4 rounded-lg border bg-background p-4" key={item.label}>
